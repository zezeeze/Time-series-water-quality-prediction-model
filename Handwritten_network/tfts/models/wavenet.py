...
from Handwritten_network.tfts.layers.attention_layer import FullAttention
from Handwritten_network.tfts.layers.cnn_layer import ConvTemp
from Handwritten_network.tfts.layers.dense_layer import DenseTemp
